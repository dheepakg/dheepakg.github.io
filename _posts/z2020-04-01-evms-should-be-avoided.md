...
date:  2020-04-01 12:33:17 +0530
categories: Opinion
Tags: Election, EVM, India
comments: true
---
...
As the EVMs venture into cyber space, we shouldn’t ignore some of the laws of pertaining to Information security.
    ...
    * The system is as safe with the weakest link, [we people are the weakest link](https://www.csoonline.com/article/3095486/cybersecurity-is-only-as-strong-as-your-weakest-linkyour-employees.html).
    * [Open systems are more secure](https://www.reddit.com/r/linux/comments/3lxd0t/open_source_software_is_more_secure/cva33y9/) than proprietary
...
The point of failure for the EVMs are quite a handful,
    ...
    * Setting up of EVMs in the voting booth before the commencement of election.
    * Man in the middle attack while connecting individual EVMs to server to consolidate the vote counts.
    * Some coding error while writing the embedded system of the backend, which might have escaped the testing.
    * [Infiltrating into the chip during its fabrication](https://www.bloomberg.com/news/features/2018-10-04/the-big-hack-how-china-used-a-tiny-chip-to-infiltrate-america-s-top-companies), may sound far fetched, but its already a reality.
    * A power surge could fry the hardware, we don’t know whether the device is properly protected as the design is not open sourced.
...
References
    ...
    1. VVPAT system – https://economictimes.indiatimes.com/news/elections/lok-sabha/india/what-is-vvpat/articleshow/68667136.cms
